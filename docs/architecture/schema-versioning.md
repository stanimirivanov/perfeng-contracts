...
> Historical prototype policy retained for provenance. Superseded by
> [Contract compatibility](../compatibility.md). The rules below are not the
> release policy for perfeng-contracts.
